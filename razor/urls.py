...
#admin
from payments.views import View_Error, View_Admin_Login, View_Change_Password, View_Admin_Logout, students, show_students, edit_students, update_students, delete_students
...
urlpatterns = [
    ...
    path('error/',View_Error, name='error')
